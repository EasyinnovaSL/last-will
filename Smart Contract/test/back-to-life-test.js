...
contract('BackToLife', function(accounts) {
    ...
    it("BackToLife Create Accounts", function() {
        ...
        return BackToLife.deployed().then(function (instance) {
            ...
            BackToLifeContractInstance.createHierarchyContract();

            BackToLifeContractInstance.addHeirs("0xf1f42f995046e67b79dd5ebafd224ce964740da3;0x2052d46d53107b0384503be3a11935f0b5cd5342", "50;50");
